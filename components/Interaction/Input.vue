<template>
  <div class="interaction-box absolute z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 lg:w-96 w-[80] p-6 bg-white text-black rounded shadow-lg">
